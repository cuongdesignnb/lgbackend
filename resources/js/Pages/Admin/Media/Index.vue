                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="relative">
                        ...
                        <input v-model="search" type="text" placeholder="Tìm kiếm..."
                            class="pl-10 pr-4 py-2 bg-slate-800/60 text-slate-200 placeholder-slate-500 border border-slate-700/50 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500/50 w-56">
                    </div>

                    <!-- Type filter -->
                    <select v-model="filterType" @change="applyFilters()" class="bg-slate-800/60 text-slate-200 border border-slate-700/50 rounded-lg text-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-500/50">
                ...
                <div class="relative bg-slate-900 w-full max-w-md shadow-2xl overflow-y-auto">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input v-model="detailItem.name" class="w-full bg-slate-800/60 text-slate-200 placeholder-slate-500 border border-slate-700/50 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500/50">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-300 mb-1">Alt text</label>
                            <input v-model="detailItem.alt" class="w-full bg-slate-800/60 text-slate-200 placeholder-slate-500 border border-slate-700/50 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500/50" placeholder="Mô tả hình ảnh">
                        </div>
            ...
            <div v-if="showNewFolderModal" class="fixed inset-0 z-[60] flex items-center justify-center">
                ...
                <div class="relative bg-slate-900 rounded-xl shadow-2xl w-full max-w-sm mx-4 p-6">
                    ...
                    <input v-model="newFolderName" @keydown.enter="createFolder" placeholder="Tên thư mục (a-z, 0-9, -, _)"
                        class="w-full bg-slate-800/60 text-slate-200 placeholder-slate-500 border border-slate-700/50 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500/50 mb-4">
                    <div class="flex justify-end gap-3">
